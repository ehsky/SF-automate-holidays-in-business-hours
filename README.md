...
24.04.2022: Apex-mdapi have wrong Datatype in class MetadatService.BusinessHoursEntry. All DateTime should be Time. Will maybe file a bug to there repo. Some rubish test code is added in the script folder. Able to create xml file, but deployment fails with unkown error.
